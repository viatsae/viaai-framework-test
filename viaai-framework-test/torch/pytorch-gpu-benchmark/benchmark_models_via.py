...
parser.add_argument('--NUM_TEST','-n', type=int,default=30,required=False, help="Num of Test")
parser.add_argument('--BATCH_SIZE','-b', type=int, default=2, required=False, help='Num of batch size')
...
if __name__ == '__main__':
    ...
    for i in precision:
        ...
        training_benchmark.to_csv('results/test.csv', index=False)
